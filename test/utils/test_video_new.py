...
class TestVideo:
    ...
    def test_video_init(self, mock_backend):
        ...
        with patch("supervision.utils.video_new.get_backend", return_value=mock_backend):
    ...
    def test_video_init_with_backend(self, mock_backend):
        ...
        with patch("supervision.utils.video_new.get_backend", return_value=mock_backend) as get_backend_mock:
    ...
    def test_video_frames_with_stride(self, mock_backend, sample_video_info, sample_frames):
    ...
    def test_video_frames_with_range(self, mock_backend, sample_video_info, sample_frames):
    ...
    def test_video_save_simple(self, mock_backend, sample_video_info, sample_frames):
        ...
        with patch("supervision.utils.video_new.get_backend", return_value=mock_backend):
            ...
            mock_backend.writer.assert_called_once_with("output.mp4", sample_video_info, None)
            
            # Check all frames were written
            assert mock_writer.write.call_count == len(sample_frames)
            mock_writer.close.assert_called_once()

    def test_video_save_with_callback(self, mock_backend, sample_video_info, sample_frames):
    ...
    def test_video_sink_with_custom_info(self, mock_backend, sample_video_info):
        ...
        with patch("supervision.utils.video_new.get_backend", return_value=mock_backend):
            ...
            # Check writer was created with custom info
            mock_backend.writer.assert_called_once_with("output.mp4", custom_info, "h265")
