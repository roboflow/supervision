...
from supervision.dataset.utils import split_coco_dataset, split_data, verify_coco_split
...
class TestCOCODatasetSplitting:
    ...
    def sample_coco_data(self):
        ...
        return {
            ...
            "licenses": [{"id": 1, "name": "Test License", "url": "http://test.com"}],
            "categories": [
    ...
    def test_split_coco_dataset_basic(self, setup_test_dataset):
        ...
        total_images = (
            stats["train"]["images"] + stats["val"]["images"] + stats["test"]["images"]
        )
        ...
        assert (
            abs(stats["val"]["images"] / total - 0.2) < 0.1
    ...
    def test_split_coco_dataset_invalid_inputs(self, setup_test_dataset):
        ...
        with pytest.raises(
            ValueError, match="Sum of val_percentage and test_percentage must be < 1.0"
        ):
            split_coco_dataset(
                annotations_path=data["annotations_file"],
                images_directory=data["images_dir"],
    ...
    def test_verify_coco_split_with_duplicates(self, setup_test_dataset):
        ...
        train_data = {
            ...
            "annotations": [
                ann for ann in original_data["annotations"] if ann["image_id"] <= 5
            ],
        }
        ...
        val_data = {
            ...
            "annotations": [
                ann for ann in original_data["annotations"] if ann["image_id"] <= 3
            ],
        }
        ...
        for split_name in ["train", "val", "test"]:
            ...
            if split_file.exists():
                ...
                annotation_image_ids = {
                    ann["image_id"] for ann in split_data["annotations"]
                }
    ...
    def test_real_world_edge_cases(self):
        ...
        edge_case_data = {
            ...
            "images": [
                ...
                {
                    "id": 3,
                    "file_name": "image_with_ann2.jpg",
                    "width": 640,
                    "height": 480,
                },
                {
                    "id": 4,
                    "file_name": "image_no_ann2.jpg",
                    "width": 640,
                    "height": 480,
                },
            ],
