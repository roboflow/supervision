...
from supervision.dataset.core import (BaseDataset, ClassificationDataset,
                                      DetectionDataset)
...
from supervision.detection.utils import (box_iou_batch,
                                         ...
                                         mask_to_polygons, mask_to_xyxy,
                                         non_max_suppression, polygon_to_mask,
                                         polygon_to_xyxy)
from supervision.draw.color import Color, ColorPalette
from supervision.draw.utils import (draw_filled_rectangle, draw_polygon,
                                    draw_text)
