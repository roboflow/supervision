...
def process_tensor_result(segmentation_array: np.ndarray, id2label: Optional[Dict[int, str]]) -> Detections:
...
def process_detection_result(detection_result: dict, id2label: Optional[Dict[int, str]]) -> Detections:
...
def process_transformers_v4_segmentation_result(segmentation_result: dict, id2label: Optional[Dict[int, str]]) -> Detections:
    """
...
def process_transformers_v5_segmentation_result(segmentation_result: dict, id2label: Optional[Dict[int, str]]) -> Detections:
    """
...
def process_segmentation_result(segmentation_result: dict, id2label: Optional[Dict[int, str]]) -> Detections:
...
def process_png_segmentation_result(png_result: dict, id2label: Optional[Dict[int, str]]) -> Detections:
