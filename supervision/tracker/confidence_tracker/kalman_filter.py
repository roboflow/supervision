...
class KalmanFilter(object):
    ...
    Parameters:
        conf_thresh (float, optional): For detection boxes whose confidence score
            are lower than conf_threshold, change the location of the "measurement"
            (detected box) to be closer to the location of the predicted box,
            weighted by the confidence of the box.

            Equation:
            measurement = measurement + (projected_mean - measurement) * conf_cost

        cov_alpha (int, optional): Amplifying coefficient for Noise Scale Adaptive
            Kalman Filter. If the confidence is low, then the noise in the
            covariance projected into the measurement space is greater.
    ...
    def __init__(self, conf_thresh: float = 0.6, cov_alpha: int = 10):
        ndim, dt = 4, 1.0
    ...
    def project(
        ...
        Args:
            ...
            confidence (float): The confidence of the current measurement.
        ...
        innovation_cov = innovation_cov * (1 - confidence) * self.cov_alpha
    ...
    def update(
        ...
        Args:
            ...
            confidence (float): The confidence of the measurement.
