...
def _mask_iou_batch_split(
    ...
    """
    # Pairwise intersection counts via a flatten + matmul, which avoids
    # materialising the (N, M, H, W) overlap array — the dominant memory and
    # time cost here. Counts are bounded by H*W and stay exact in float32 for
    # any mask that fits a realistic image.
